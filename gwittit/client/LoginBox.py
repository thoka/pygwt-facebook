...
from com.google.gwt.event.dom.client import ClickEvent, ClickHandler
...
from gwittit.client.facebook import FacebookConnect, LoginCallback
from gwittit.client.facebook.xfbml import FbLoginButton, Xfbml
