...
class Groups_get(Showcase):
    ...
    def __init__(self, ):
        ...
        self.apiClient.groupsGet(None, class anonymous(AsyncCallback)():
                                           ...
                                           def onSuccess(self, groups):
                                               ...
                                               for g in groups:
                                                   ...
                                                   memberLink.addClickHandler(class anonymous(ClickHandler)():
    ...
    def displayMembers(self, membersWrapper, gid):
        ...
        self.apiClient.groupsGetMembers(gid, class anonymous(AsyncCallback)():
                                                 ...
                                                 def onSuccess(self, groupMembers):
                                                     ...
                                                     self.displayProfilePicsPanel(membersWrapper, u"Not Replied", groupMembers.getNotReplied())) #  Get members in this group
